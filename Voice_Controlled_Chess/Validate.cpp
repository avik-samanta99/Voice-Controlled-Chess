...
bool whitePawnValidity(Position oldPosition, Position newPosition, vector<vector<int>>& chessBoard) {
...
bool blackPawnValidity(Position oldPosition, Position newPosition, vector<vector<int>>& chessBoard) {
    if (newPosition.y == oldPosition.y && newPosition.x == oldPosition.x + 1) {
        if (chessBoard[newPosition.x][newPosition.y]) return false;
        return true;
    }
...
bool RookValidity(Position oldPosition, Position newPosition, vector<vector<int>>& chessBoard) {
...
bool BishopValidity(Position oldPosition, Position newPosition, vector<vector<int>>& chessBoard) {
...
bool KnightValidity(Position oldPosition, Position newPosition, vector<vector<int>>& chessBoard) {
...
bool QueenValidity(Position oldPosition, Position newPosition, vector<vector<int>>& chessBoard) {
    return (RookValidity(oldPosition, newPosition, chessBoard) || BishopValidity(oldPosition, newPosition, chessBoard));
}

bool KingValidity(Position oldPosition, Position newPosition, vector<vector<int>>& chessBoard) {
    if (chessBoard[oldPosition.x][oldPosition.y] == 0) return false;
